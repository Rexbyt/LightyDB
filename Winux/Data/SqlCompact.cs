...
//        public SqlCompact(string connectionString) {
//            try
//            {
...
//        {
//            SqlCommand cmd = new SqlCommand("SELECT SCOPE_IDENTITY()", this.Connection);
...
//                    this.Open();
//                    SqlCommand cmd = new SqlCommand("USE "+baseName+"; EXECUTE "+procedure, this.Connection);
...
//            SqlCommand cmd = new SqlCommand("SELECT MAX(id) FROM " + tblName,this.Connection);
//            object val = cmd.ExecuteScalar();
//            return Convert.ToInt32(val);
//        }
